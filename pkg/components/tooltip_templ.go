...
func Tooltip(props TooltipProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div x-data=\"tooltip\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if props.OpenDelay > 0 {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" data-open-delay=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		if props.CloseDelay > 0 {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" data-close-delay=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" class=\"relative inline-block\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("><!-- Trigger --><div @mouseenter=\"show\" @mouseleave=\"handleMouseLeave\" @focus=\"show\" @blur=\"hide\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><!-- Tooltip -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div x-show=\"visible\" x-transition:enter=\"transition ease-out duration-200\" x-transition:enter-start=\"opacity-0 scale-95\" x-transition:enter-end=\"opacity-100 scale-100\" x-transition:leave=\"transition ease-in duration-100\" x-transition:leave-start=\"opacity-100 scale-100\" x-transition:leave-end=\"opacity-0 scale-95\" @mouseenter=\"show\" @mouseleave=\"hide\" class=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\"><!-- Arrow -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if props.ShowArrow {
