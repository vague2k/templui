...
func PopoverContent(props ...PopoverContentProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ShowArrow {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<!-- Alle möglichen Pfeil-Varianten einfügen, damit sie bei Positionswechseln korrekt angezeigt werden --> <!-- Top-Pfeile --> <div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background top-[-5px] left-1/2 -translate-x-1/2 border-t border-l\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background top-[-5px] left-4 border-t border-l\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background top-[-5px] right-4 border-t border-l\"></div><!-- Bottom-Pfeile --> <div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background bottom-[-5px] left-1/2 -translate-x-1/2 border-b border-r\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background bottom-[-5px] left-4 border-b border-r\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background bottom-[-5px] right-4 border-b border-r\"></div><!-- Left-Pfeile --> <div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background left-[-5px] top-1/2 -translate-y-1/2 border-b border-l\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background left-[-5px] top-2 border-b border-l\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background left-[-5px] bottom-2 border-b border-l\"></div><!-- Right-Pfeile --> <div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background right-[-5px] top-1/2 -translate-y-1/2 border-t border-r\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background right-[-5px] top-2 border-t border-r\"></div><div class=\"absolute h-2.5 w-2.5 rotate-45 bg-background right-[-5px] bottom-2 border-t border-r\"></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
