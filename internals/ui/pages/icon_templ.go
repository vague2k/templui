...
import (
	...
	"github.com/axzilla/goilerplate/pgk/icons"
)
...
func Icon() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div><div class=\"mb-16\"><h1 class=\"text-3xl font-bold mb-2\">Icon</h1><p class=\"mb-4 text-muted-foreground\">A wrapper for Lucide Icons with optional settings for size, color, fill, stroke, and custom classes. To use this component, you'll also need the code or component from the \"Icon\" tab!</p></div>")
			if templ_7745c5c3_Err != nil {
